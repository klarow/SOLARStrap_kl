...
#KL2 add in cov file
def main(demographic_file, family_file, pedigree_file, trait_path, cov_file,
        ...
        for icd9 in diags_to_process:
            ...
            for eth in ethnicities:
                ...
                if num_families > len(families_with_case[eth][icd9]):
                    ...
                    continue
                #KL5 added covariates to solar_strap
...
if __name__ == '__main__':
    ...
    print >> sys.stderr, ""
#KL1 added cov to valud arguments, and to main as cov_file
    valid_args = ('demog', 'fam', 'ped', 'trait', 'cov', 'sd', 'type', 'nfam', 'slice',
